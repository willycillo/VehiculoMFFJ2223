 ...
 */
public class VehiculoMartinFernandezFranciscoJavier2223 {
    ...
    public VehiculoMartinFernandezFranciscoJavier2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoMartinFernandezFranciscoJavier2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
